...
| --- | --- | --- |
| General autonomy classes, two-failure stop, concurrency, monitoring and handoff rules | Original [autonomy](AUTONOMOUS_DEVELOPMENT.md#autonomy-contract) and [execution rules](AUTONOMOUS_DEVELOPMENT.md#execution-and-monitoring-rules) sections | Current general rules; unchanged. Handbook review levels, zero-findings task gates and live-smoke conditions are unchanged. |
