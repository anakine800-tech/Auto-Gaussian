...
class ReleaseHygieneTests(unittest.TestCase):
    ...
    def test_offline_ci_uses_audited_actions_and_supported_python_matrix(self) -> None:
        ...
        self.assertEqual(workflow.count("python scripts/audit_python_contract.py"), 2)
    ...
    def test_current_version_surfaces_match_pyproject(self) -> None:
        ...
        self.assertTrue(
            checklist_text.startswith(
                f"# Auto-G16 {version} Release Preparation Checklist\n"
            )
        )
        rfc = (ROOT / "docs" / "v2.6-platform-portability-rfc.md").read_text(
            encoding="utf-8"
        )
