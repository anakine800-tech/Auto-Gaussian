...
promote them. Maturity `/1` remains insufficient. Maturity `/2` is version-aware
replayable, but remains blocked by its minimum candidate-to-input-to-result
lineage and by exact TS/IRC/thermochemistry owner requirements. No barrier
arithmetic or live action is available.
